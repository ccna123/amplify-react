...
const ReturnFlight = ({ trip }) => {
  return (
    <div className="rounded-md mb-1 p-3 shadow-[0px_4px_16px_rgba(17,17,26,0.1),_0px_8px_24px_rgba(17,17,26,0.1),_0px_16px_56px_rgba(17,17,26,0.1)]">
      ...
      <section className="flex items-center justify-center">
        ...
        <i className="fa-solid fa-plane text-xl text-button-green rotate-180" />
